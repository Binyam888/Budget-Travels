...
const Header = () => {
  return (
    <div className="header flex flex-col mt-[30px] lg:flex lg:flex-row lg:justify-center lg:mb-[60px] lg:pt-[40px] lg:pb-[40px]" id="Home">
      <div className="header-left flex justify-center">
        ...
        <h1 className="text-3xl font-bold text-green-700 font-sans ">EXPLORING</h1>
        ...
        <div className="button pt-[10px]">
            <button className="bg-black p-2 px-3 rounded-xl shadow-md shadow-neutral-500 animate-pulse lg:scale-105">Book Now</button>
        </div>
        </div>
