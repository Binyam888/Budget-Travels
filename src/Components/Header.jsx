...
const Header = () => {
  return (
    <div className="header flex flex-col mt-[30px]" id="Header">
      <div className="header-left flex justify-center">
        ...
        <div className="button pt-[10px]">
            <button className="bg-black p-2 px-3 rounded-xl shadow-md shadow-neutral-500 animate-pulse">Book Now</button>
        </div>
        </div>
       
      </div>
      <div className="header-right flex justify-center mt-[20px]">
