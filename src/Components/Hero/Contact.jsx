...
const Contact = () => {
  ...
  return (
    <div
      className="contact mb-[20px] mt-[25px] lg:mt-[100px]  "
      id="Contact"
      data-aos="fade-right"
    >
      ...
      <div className="contact-section flex  justify-center lg:flex lg:justify-aroun">
        <div className="  hidden   icon lg:flex  pl-[20px]">
          <img
            src={mobile}
            className="h-[400px] mt-[80px] ml-[25px] animate-bounce"
            alt="mobile"
          />
        </div>
        <div className="contact-form flex justify-center flex-col">
          <h1 className="text-black text-center font-bold mb-[10px]">
            Fill your Details
          </h1>
          <form
            className="flex scale-75 md:scale-105 flex-col justify-center hover:shadow-lg duration-300 p-3  py-[21px] rounded-md"
            action="submit"
          >
            <input
            ...
            <div className="button mb-[10px]">
              <button
                onClick={onSubmit}
                className="bg-black p-2 px-5 rounded-md shadow-md shadow-neutral-500"
              >
                Send
              </button>
            </div>
          ...
          <div className="social-icons flex justify-center text-black mt-[30px]">
            <ul className="flex cursor-pointer mb-[20px] duration-300 ">
              <li className="bg-white rounded-full  mr-[10px] drop-shadow-md p-3 d hover:bg-neutral-300  duratio-300 ">
                {" "}
                <a href="">
                  <FaInstagram size={20} />
                </a>{" "}
              </li>
              <li className="bg-white  rounded-full mr-[10px]  drop-shadow-md  p-3 hover:bg-neutral-300 ">
                {" "}
                <a href="">
                  {" "}
                  <FaWhatsapp size={20} />
