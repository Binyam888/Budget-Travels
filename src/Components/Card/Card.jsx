...
const Card = (props) => {
  ...
  return (
    <div
      className="card bg-neutral-300 rounded-xl shadow-lg shadow-neutral-400 my-[20px] ml-[20px]"
      data-aos="fade-right"
    >
      <div className="parent relative">
        <div className="card-img   rounded-xl overflow-hidden shadow-md shadow-black ">
          <img
            src={pic}
            alt="img"
            className="h-[180px] w-[285px]  object-cover"
          />
        </div>
        <div className="Child absolute h-[180px] w-[285px] bg-gradient bg-gradient-to-b from-transparent via-transparent to-black top-0 rounded-xl"></div>
      </div>
      ...
      <div className="button py-2  flex justify-end align-bottom ">
        <button className="bg-black p-2 px-5 rounded-md shadow-md shadow-neutral-500 scale-75 ">
          Book Now
        </button>
      </div>
    </div>
