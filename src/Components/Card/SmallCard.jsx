...
const SmallCard = (props) => {
  ...
  return (
    <div className="smallCard flex flex-col justify-center bg-neutral-300 hover:bg-neutral-400 duration-300 rounded-lg w-[250px] mb-[20px] shadow-md shadow-neutral-400 pb-[10px] md:ml-[20px] ml-[10px]">
